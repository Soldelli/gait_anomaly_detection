...
def main_preprocessing(which_data):
    ...
    if data_normalization:
        if not os.path.exists('./data/preprocessed_data/'):         # create directory is not present
...
if __name__ == '__main__':
    ...
    main_preprocessing(which_data='raw_data')               # Standard data, tipical walking behaviour for neural network
                                                            # training and testing.
    #main_preprocessing(which_data='raw_data_classifier')   # Standard data, tipical walking behaviour for classifier
                                                            # training and testing.
    #main_preprocessing(which_data='raw_events_data')       # Data with events

    #main_preprocessing(which_data='raw_data_test')

    #main_preprocessing(which_data='raw_data_test_events')